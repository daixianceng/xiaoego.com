...
$this->title = '订单详情';
?>
<?php if ($model->status === Order::STATUS_UNSHIPPED && $model->payment === Order::PAYMENT_OFFLINE) :?>
<div class="alert alert-info" role="alert">
    <strong>重要提示！</strong> 该订单属于货到付款，请您在配送时不要忘记收费
</div>
<?php endif;?>
<p>
...
<div class="row">
    <div class="col-lg-12">
        <div class="well well-lg">
            ...
            <p><strong>用户：</strong><?= $model->user->mobile ?></p>
